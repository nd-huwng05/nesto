...
class RoomCategoryAdmin(admin.ModelAdmin):
    list_display = ("id", "name", "branch", "base_price", "max_guests", "created_at")
    list_filter = ("branch", "max_guests", "created_at")
...
class MaintenanceIssueAdmin(admin.ModelAdmin):
    list_display = ("id", "branch", "room", "issue_type", "is_resolved", "created_at")
    list_filter = ("is_resolved", "branch", "issue_type", "created_at")
    search_fields = ("id", "room__room_number", "issue_type", "description", "branch__name")
    ordering = ("-created_at",)
